...
c***********************************************************************
     ...
     x        'error - failed allocation of site arrays'
          elseif(kode.eq.1091)then
            write(nrite,'(/,/,1x,a)')
     x        'error - failed allocation of void arrays'
          endif
     ...
     x        'error - ensemble unavailable for metadynamics'
        ...
        elseif(kode.gt.3000)then

          if(kode.eq.3001)then
            write(nrite,'(/,/,1x,a)')
     x        'error - alloc_nhc_arrays allocation failure'
          
          elseif(kode.eq.3002)then
            write(nrite,'(/,/,1x,a)')
     x        'error - alloc_nhc_arrays deallocation failure'
